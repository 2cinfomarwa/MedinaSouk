...
use Souk\FrontEndBundle\Entity\Media;
...
class MediaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $media = $em->getRepository('SoukFrontEndBundle:Media')->findAll();
    ...
    {
        $medium = new Medium();
        $form = $this->createForm('Souk\FrontEndBundle\Form\MediaType', $medium);
    ...
    {
        $deleteForm = $this->createDeleteForm($medium);
        $editForm = $this->createForm('Souk\FrontEndBundle\Form\MediaType', $medium);
