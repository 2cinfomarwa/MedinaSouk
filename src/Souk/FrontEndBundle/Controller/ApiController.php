...
/********************details commandes ***********************///////
    ...
    public  function Api_Event_allAction()
    {
        $event= $this->getDoctrine()->getManager()
            ->getRepository('SoukFrontEndBundle:Event')->findAll();
    ...
    public  function Api_Event_findAction($id)
    {
        $Event = $this->getDoctrine()->getManager()
            ->getRepository('SoukFrontEndBundle:Event')->find($id);
