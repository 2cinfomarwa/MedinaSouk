...
use Souk\FrontEndBundle\Entity\Promotion;
...
class PromotionController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Souk\FrontEndBundle\Form\PromotionType', $promotion);
    ...
    {
        $deleteForm = $this->createDeleteForm($promotion);
        $editForm = $this->createForm('Souk\FrontEndBundle\Form\PromotionType', $promotion);
